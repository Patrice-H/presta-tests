...
class appAppKernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('0gEFIFkKk2', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sq4r+cOQCF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('8.1.1', '%s?%s'), new \Symfony\Component\Asset\Context\RequestStackContext($d, '', false)), [])));
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+Ve1dOpAgo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LwHUBjH8+X', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gt5xzAstl8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iudwtg1ZHt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MYFn67RCHv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vbvXI3CfQj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AzINWvodz-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('99LPIr96Yg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SQDXqr1zu5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5wZNIhDAwD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4yRkjNwRy5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('NKRvB6xLMUMczjj7RneO8vdUj8DwP8cUaPPiWaqJyIKT4NUdP5iGGMzRMaGoYjtu'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'secret' => 'NKRvB6xLMUMczjj7RneO8vdUj8DwP8cUaPPiWaqJyIKT4NUdP5iGGMzRMaGoYjtu',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2023-09-27',
            'locale' => 'fr-FR',
            'use_debug_toolbar' => true,
            'cookie_key' => 'rxts91LW7otYmXTIptNa4DetNYhsvj1L38cJSUknnvz9Jb8RLQIaYVBwASAixUBd',
            'cookie_iv' => 'I5T9LJQInuogsc5gfMGGcYPYrt022tfs',
            'new_cookie_key' => 'def0000075e482abcd4c26e50bb28e5b0093d1d94ba392fcaceb0f293fd44cb85712d52580cace1e066bdbddab9884c160ccd95d4e65dfd2a174d1e666fc94c62da023eb',
            ...
            'modules_translation_paths' => [
                ...
                2 => (\dirname(__DIR__, 4).'/modules/blockwishlist/translations'),
                3 => (\dirname(__DIR__, 4).'/modules/psgdpr/translations'),
                4 => (\dirname(__DIR__, 4).'/modules/ps_contactinfo/translations'),
                5 => (\dirname(__DIR__, 4).'/modules/ps_languageselector/translations'),
                6 => (\dirname(__DIR__, 4).'/modules/ps_currencyselector/translations'),
                7 => (\dirname(__DIR__, 4).'/modules/ps_customersignin/translations'),
                8 => (\dirname(__DIR__, 4).'/modules/ps_shoppingcart/translations'),
                9 => (\dirname(__DIR__, 4).'/modules/ps_mainmenu/translations'),
                10 => (\dirname(__DIR__, 4).'/modules/ps_searchbar/translations'),
                11 => (\dirname(__DIR__, 4).'/modules/ps_imageslider/translations'),
                12 => (\dirname(__DIR__, 4).'/modules/ps_featuredproducts/translations'),
                13 => (\dirname(__DIR__, 4).'/modules/ps_banner/translations'),
                14 => (\dirname(__DIR__, 4).'/modules/ps_customtext/translations'),
                15 => (\dirname(__DIR__, 4).'/modules/ps_specials/translations'),
                16 => (\dirname(__DIR__, 4).'/modules/ps_newproducts/translations'),
                17 => (\dirname(__DIR__, 4).'/modules/ps_bestsellers/translations'),
                18 => (\dirname(__DIR__, 4).'/modules/ps_emailsubscription/translations'),
                19 => (\dirname(__DIR__, 4).'/modules/ps_socialfollow/translations'),
                20 => (\dirname(__DIR__, 4).'/modules/ps_customeraccountlinks/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/productcomments/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/ps_categorytree/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/dashproducts/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/ps_faviconnotificationbo/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/ps_viewedproduct/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/statssearch/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
            ],
            ...
            'kernel.secret' => 'NKRvB6xLMUMczjj7RneO8vdUj8DwP8cUaPPiWaqJyIKT4NUdP5iGGMzRMaGoYjtu',
