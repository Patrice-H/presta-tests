...
/* Smarty version 4.3.1, created on 2023-10-09 17:04:38
  from 'C:\wamp64\www\presta-tests\themes\probusiness\modules\ets_multilayerslider\views\templates\hook\multilayerslider.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_65241686818dd9_20139854',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '03d815a3621d040c39b646fb95a255ec2098c7f1' => 
    array (
      0 => 'C:\\wamp64\\www\\presta-tests\\themes\\probusiness\\modules\\ets_multilayerslider\\views\\templates\\hook\\multilayerslider.tpl',
      1 => 1696862955,
      2 => 'file',
    ),
  ),
...
function content_65241686818dd9_20139854 (Smarty_Internal_Template $_smarty_tpl) {
if ((isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'])) && $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'] == 'layouthome2') {?>
 ...
 type="text/javascript">
        ...
        var height_slider = 460;
    <?php echo '</script'; ?>
>
<?php } elseif ((isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'])) && $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'] == 'layouthome3') {?>
    <?php echo '<script'; ?>
 type="text/javascript">
        var width_slider = 1937;
        var height_slider = 522;
    <?php echo '</script'; ?>
>
<?php } else { ?>
    <?php echo '<script'; ?>
 type="text/javascript">
        var width_slider = 873;
        var height_slider = 460;
    <?php echo '</script'; ?>
>
<?php }?>
...
" style=" <?php if ((isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'])) && $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'] == 'layouthome2') {?>width: 1170px; height: 460px; <?php } elseif ((isset($_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'])) && $_smarty_tpl->tpl_vars['tc_config']->value['YBC_TC_LAYOUT'] == 'layouthome3') {?>width: 1937px; height: 522px; <?php } else { ?> width: 873px; height: 460px; <?php }?> <?php if ($_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BACKGROUND']) {?>background-color: <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_configs']->value['ETS_MLS_SLIDER_BACKGROUND'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
...
?>
                            <?php if ($_smarty_tpl->tpl_vars['layer']->value['layer_type'] == 'image' && $_smarty_tpl->tpl_vars['layer']->value['image'] || $_smarty_tpl->tpl_vars['layer']->value['layer_type'] != 'image' && $_smarty_tpl->tpl_vars['layer']->value['content_layer']) {?>
                                <div class="msl_layer_front<?php if ((isset($_smarty_tpl->tpl_vars['slide']->value['custom_class'])) && $_smarty_tpl->tpl_vars['layer']->value['custom_class']) {?> <?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['custom_class'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
 <?php }?> msl_layer_<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['layer']->value['id_layer'] )), ENT_QUOTES, 'UTF-8');?>
...
;<?php } else { ?>#000000;<?php }?>"><img alt="" src="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['mls_img_base_dir']->value,'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
ajax-loader.gif"/></div>
        <?php }?>
...
;<?php }?>"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Prev','mod'=>'ets_multilayerslider'),$_smarty_tpl ) );?>
</div>
...
;<?php }?>"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Next','mod'=>'ets_multilayerslider'),$_smarty_tpl ) );?>
</div>
            </div>
        <?php }?>
...
?>
                    <?php $_smarty_tpl->_assignInScope('ik', $_smarty_tpl->tpl_vars['ik']->value+1);?>
                    <div class="mls_pag_button mls_pag_<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['ik']->value )), ENT_QUOTES, 'UTF-8');?>
