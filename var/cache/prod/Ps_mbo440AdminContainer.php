 ...
 * @final
 */
class Ps_mbo440AdminContainer extends Container
{
    private $parameters = [];
    ...
    {
        return $this->services['mbo.accounts.data_provider'] = new \PrestaShop\Module\Mbo\Accounts\Provider\AccountsDataProvider(($this->services['mbo.ps_accounts.facade'] ?? $this->getMbo_PsAccounts_FacadeService()));
    }
    ...
    {
        return $this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, 'E:\\Projets\\presta-tests/var/cache/prod\\%/ps_mbo');
    }
    ...
    {
        return $this->services['mbo.doctrine.cache.provider'] = new \Symfony\Component\Cache\DoctrineProvider(($this->services['mbo.doctrine.cache.adapter'] ?? ($this->services['mbo.doctrine.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('', 0, 'E:\\Projets\\presta-tests/var/cache/prod\\%/ps_mbo'))));
    }
