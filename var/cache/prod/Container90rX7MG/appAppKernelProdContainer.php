...
class appAppKernelProdContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('t-TMA+qj7d', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XZYDhpC73O', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8EbDNvo00BGmw2yaNVyaKmvRTbXTDSVLMEt0GTD0J7TgBY6bC1LZh9WkOOfdjfq4'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                33 => 'mbeshipping',
                34 => 'pagesnotfound',
                35 => 'psxmarketingwithgoogle',
                36 => 'ps_accounts',
                37 => 'ps_eventbus',
                38 => 'ps_brandlist',
                39 => 'ps_cashondelivery',
                40 => 'ps_categoryproducts',
                41 => 'ps_checkout',
                42 => 'ps_checkpayment',
                43 => 'ps_crossselling',
                44 => 'ps_dataprivacy',
                ...
                57 => 'statsbestmanufacturers',
                58 => 'statsbestproducts',
                59 => 'statsbestsuppliers',
                60 => 'statsbestvouchers',
                61 => 'statscarrier',
                62 => 'statscatalog',
                63 => 'statscheckup',
                64 => 'statsdata',
                65 => 'statsforecast',
                66 => 'statsnewsletter',
                67 => 'statspersonalinfos',
                68 => 'statsproduct',
                69 => 'statsregistrations',
                70 => 'statssales',
                71 => 'statssearch',
                72 => 'statsstock',
                73 => 'ps_facetedsearch',
            ...
            'kernel.secret' => '8EbDNvo00BGmw2yaNVyaKmvRTbXTDSVLMEt0GTD0J7TgBY6bC1LZh9WkOOfdjfq4',
