...
/* @MailThemes\modern\modules\ps_emailalerts\customer_qty.html.twig */
class __TwigTemplate_ccc6adfc1538aca11bd138f954511286bcc1f9a2d723d02c1296e314d54ff050 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("@MailThemes/modern/components/layout.html.twig", "@MailThemes\\modern\\modules\\ps_emailalerts\\customer_qty.html.twig", 1);
    ...
    {
        $macros = $this->macros;
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Customer Quantity", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("{product} is now available.", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Good news, this item is back in stock!", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                      <tr>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Click on the following link to visit the product page and order it:", [], "Emails.Body", ($context["locale"] ?? null));
        echo " <a href=\"{product_link}\" target=\"_blank\">{product}</a></div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
";
    ...
    {
        return "@MailThemes\\modern\\modules\\ps_emailalerts\\customer_qty.html.twig";
    }
    ...
    {
        return array (  275 => 151,  271 => 150,  244 => 128,  240 => 127,  231 => 123,  227 => 122,  214 => 114,  209 => 112,  180 => 88,  176 => 87,  163 => 79,  158 => 77,  125 => 49,  118 => 47,  89 => 23,  85 => 22,  71 => 13,  66 => 11,  59 => 6,  55 => 5,  48 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@MailThemes\\modern\\modules\\ps_emailalerts\\customer_qty.html.twig", "C:\\wamp64\\www\\presta-tests\\mails\\themes\\modern\\modules\\ps_emailalerts\\customer_qty.html.twig");
    }
}
