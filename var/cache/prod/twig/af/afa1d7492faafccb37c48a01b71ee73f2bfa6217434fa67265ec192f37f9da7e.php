...
class __TwigTemplate_4e8a85bf7f01016f9d2d26ecb491bdef6208710f0bec0fdae0552d339c8d97fe extends Template
{
    private $source;
    private $macros = [];
    ...
    <nav>
      <ol class=\"breadcrumb\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 31
            echo "          ";
            $context["isRootCategory"] = (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["category"], "id_parent", [], "any", false, false, false, 31), 0));
            // line 32
            ...
            if ((($context["isRootCategory"] ?? null) && ($context["isSingleShopContext"] ?? null))) {
                // line 34
                echo "              ";
                if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["category"], "id_category", [], "any", false, false, false, 34), twig_get_attribute($this->env, $this->source, ($context["currentCategoryView"] ?? null), "id", [], "any", false, false, false, 34)))) {
                    // line 35
                    echo "                <span>";
              ...
              ";
                ...
                // line 41
                echo "            ";
            } elseif ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["category"], "id_category", [], "any", false, false, false, 41), twig_get_attribute($this->env, $this->source, ($context["currentCategoryView"] ?? null), "id", [], "any", false, false, false, 41)))) {
                // line 42
                echo "              <span>";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Sell/Catalog/Categories/Blocks/breadcrumb.html.twig", "E:\\Projets\\presta-tests\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Catalog\\Categories\\Blocks\\breadcrumb.html.twig");
    }
}
