...
/* @MailThemes\modern\core\guest_to_customer.html.twig */
class __TwigTemplate_2f28181992ba8c7159fbc48c6c1f9622e48cf8f761c2ca4c77dbab151ad39171 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("@MailThemes/modern/components/layout.html.twig", "@MailThemes\\modern\\core\\guest_to_customer.html.twig", 1);
    ...
    {
        $macros = $this->macros;
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Guest to customer", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Your guest account has been turned into a customer account", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Congratulations, your guest account for [1]{shop_name}[/1] has been turned into a customer account!", ["[1]" => "<span class=\"label\">", "[/1]" => "</span>"], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                      <tr>
        ...
        echo "</span> <span style=\"color:#25B9D7;font-weight:600\">{email}</span><br><br>
                                            ";
        // line 129
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Click on the following link to set up your password:", [], "Emails.Body", ($context["locale"] ?? null));
        ...
        // line 161
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("You can access your customer account on our store:", [], "Emails.Body", ($context["locale"] ?? null));
        echo " <a href=\"{shop_url}\" target=\"_blank\" style=\"color:#25B9D7; text-decoration:none; display:block; font-weight: 400;\">{shop_name}</a></div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
...
";
    ...
    {
        return "@MailThemes\\modern\\core\\guest_to_customer.html.twig";
    }
    ...
    {
        return array (  318 => 180,  314 => 179,  293 => 161,  283 => 156,  278 => 154,  250 => 129,  244 => 128,  240 => 127,  231 => 123,  227 => 122,  214 => 114,  209 => 112,  180 => 88,  176 => 87,  163 => 79,  158 => 77,  125 => 49,  118 => 47,  89 => 23,  85 => 22,  71 => 13,  66 => 11,  59 => 6,  55 => 5,  48 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@MailThemes\\modern\\core\\guest_to_customer.html.twig", "C:\\wamp64\\www\\presta-tests\\mails\\themes\\modern\\core\\guest_to_customer.html.twig");
    }
}
