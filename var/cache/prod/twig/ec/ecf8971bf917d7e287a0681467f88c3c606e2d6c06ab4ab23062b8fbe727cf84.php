...
/* @MailThemes\modern\core\bankwire.html.twig */
class __TwigTemplate_eadb0e794f41e192b8d4b182d2d8a93536c207ca7a51c7f71398f00cf4a23d77 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("@MailThemes/modern/components/layout.html.twig", "@MailThemes\\modern\\core\\bankwire.html.twig", 1);
    ...
    {
        $macros = $this->macros;
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Bankwire", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Order ID {order_name}", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
        echo " - ";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Pending payment", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Your order with the reference [1]{order_name}[/1] has been placed successfully. You can expect [1]delivery as soon as your payment is received[/1].", ["[1]" => "<span class=\"label\">", "[/1]" => "</span>"], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Payment method: bank wire", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("You have decided to pay by bank wire.", [], "Emails.Body", ($context["locale"] ?? null));
        echo "
                                            ";
        // line 201
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Here is the information you need for your transfer:", [], "Emails.Body", ($context["locale"] ?? null));
        echo "
                                          </div>
                                        </td>
                                      </tr>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\"><span class=\"label\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Account owner:", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</span>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\"><span class=\"label\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Account details:", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</span><span> {bankwire_details}</span></div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align=\"";
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\"><span class=\"label\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Bank address:", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</span><span> {bankwire_address}</span></div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align=\"";
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Please specify your order reference in the bankwire description.", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
...
";
    ...
    {
        return "@MailThemes\\modern\\core\\bankwire.html.twig";
    }
    ...
    {
        return array (  541 => 308,  537 => 307,  514 => 289,  510 => 288,  501 => 284,  496 => 282,  471 => 262,  467 => 261,  458 => 257,  453 => 255,  424 => 231,  420 => 230,  411 => 226,  407 => 225,  398 => 221,  394 => 220,  383 => 214,  379 => 213,  368 => 207,  364 => 206,  356 => 201,  350 => 200,  346 => 199,  333 => 191,  328 => 189,  299 => 165,  295 => 164,  282 => 156,  277 => 154,  248 => 130,  244 => 129,  231 => 121,  226 => 119,  195 => 95,  191 => 94,  178 => 86,  173 => 84,  140 => 56,  133 => 54,  104 => 30,  100 => 29,  89 => 23,  85 => 22,  71 => 13,  66 => 11,  59 => 6,  55 => 5,  48 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@MailThemes\\modern\\core\\bankwire.html.twig", "C:\\wamp64\\www\\presta-tests\\mails\\themes\\modern\\core\\bankwire.html.twig");
    }
}
