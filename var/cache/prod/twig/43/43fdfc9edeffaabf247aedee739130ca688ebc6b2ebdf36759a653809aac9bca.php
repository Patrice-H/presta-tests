...
class __TwigTemplate_99149c8141c60f244acf440531378cd70f289fa58d0b3015b52f461012e2032e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 54
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["webserviceStatus"] ?? null), "isEnabled", [], "any", false, false, false, 54), true))) {
            // line 55
            echo "      <div class=\"card\">
        ...
        <div class=\"card-body\">
          ...
          ";
            // line 66
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["webserviceStatus"] ?? null), "isFunctional", [], "any", false, false, false, 66), false))) {
                // line 67
                echo "            <p>
              ";
                // line 68
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Configure/AdvancedParameters/Webservice/index.html.twig", "E:\\Projets\\presta-tests\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Configure\\AdvancedParameters\\Webservice\\index.html.twig");
    }
}
