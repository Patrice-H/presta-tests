...
class __TwigTemplate_0bcb2507abbe2e0229cb6a03ebc6c8dbd4235ff5fe4cd661b3123f838c61eb09 extends Template
{
    private $source;
    private $macros = [];
  ...
  <td class=\"img\"><div class=\"fake-img\"></div></td>
    ...
    <td class=\"attribute-finalprice text-sm-right\">
      ...
      ";
        // line 41
        if ((0 !== twig_compare($this->extensions['PrestaShopBundle\Twig\LayoutExtension']->getConfiguration("PS_USE_ECOTAX"), 0))) {
            // line 42
            echo "        ";
            ...
            // line 43
            echo "        ";
            if ((0 === twig_compare(($context["attributeEcotax"] ?? null), 0))) {
                // line 44
                echo "          ";
    ...
    <td>
      ";
        // line 279
        $context["checked"] = (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "vars", [], "any", false, false, false, 279), "value", [], "any", false, false, false, 279), "attribute_default", [], "any", false, false, false, 279), 1))) ? ("checked") : (""));
        // line 280
...
";
    ...
    {
        return new Source("", "@Product/ProductPage/Forms/form_combination.html.twig", "E:\\Projets\\presta-tests\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Product\\ProductPage\\Forms\\form_combination.html.twig");
    }
}
