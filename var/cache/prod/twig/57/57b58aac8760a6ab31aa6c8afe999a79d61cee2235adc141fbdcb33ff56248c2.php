...
class __TwigTemplate_a4d9875951f86c2d909f46e9737fb3b8df381a736dc1a9b9cff80c67bfcc1086 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Employee password", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Here is your personal login information for {shop_name}", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Here is your identification information on [1]{shop_name}[/1]", ["[1]" => "<span class=\"label\">", "[/1]" => "</span>"], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                      <tr>
        ...
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("First name:", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</span>
                                            <span> {firstname}</span>
                                          </div>
                                        </td>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\"><span class=\"label\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Last name:", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</span>
                                            <span> {lastname}</span>
                                          </div>
                                        </td>
...
";
    ...
    {
        return array (  307 => 167,  303 => 166,  274 => 142,  270 => 141,  259 => 135,  255 => 134,  244 => 128,  240 => 127,  231 => 123,  227 => 122,  214 => 114,  209 => 112,  180 => 88,  176 => 87,  163 => 79,  158 => 77,  125 => 49,  118 => 47,  89 => 23,  85 => 22,  71 => 13,  66 => 11,  59 => 6,  55 => 5,  48 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@MailThemes\\modern\\core\\employee_password.html.twig", "C:\\wamp64\\www\\presta-tests\\mails\\themes\\modern\\core\\employee_password.html.twig");
    }
}
