...
class __TwigTemplate_25246e44bb554db40535e5d9af9f697b87fb769d8d697a40f8eafa84dc897fa1 extends Template
{
    private $source;
    private $macros = [];
...
$context["action"], "type", [], "any", true, true, false, 68) && (twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 68) == "button"))) {
    ...
    {
        return new Source("", "@PrestaShop/Admin/Helpers/bootstrap_popup.html.twig", "C:\\wamp64\\www\\presta-tests\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Helpers\\bootstrap_popup.html.twig");
    }
}
