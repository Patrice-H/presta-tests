...
class __TwigTemplate_3ab80e577b342c3a74dd4c98178de5ef0e9841698ff52de6f73efc940354e281 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"category-position-column\">
  ";
        // line 27
        if (((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "sorting", [], "any", false, false, false, 27), "order_by", [], "any", false, false, false, 27), "position")) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "sorting", [], "any", false, false, false, 27), "order_way", [], "any", false, false, false, 27), "asc")))) {
            // line 28
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Columns/Content/category_position.html.twig", "E:\\Projets\\presta-tests\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Columns\\Content\\category_position.html.twig");
    }
}
