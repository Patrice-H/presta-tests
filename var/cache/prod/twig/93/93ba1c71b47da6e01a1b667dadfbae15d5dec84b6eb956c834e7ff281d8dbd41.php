...
/* @MailThemes\modern\modules\ps_emailalerts\productoutofstock.html.twig */
class __TwigTemplate_d02f46c9a2a30ea754a2dd8f44e1ec68dc45e2c35bad70564059029ff8346db2 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("@MailThemes/modern/components/layout.html.twig", "@MailThemes\\modern\\modules\\ps_emailalerts\\productoutofstock.html.twig", 1);
    ...
    {
        $macros = $this->macros;
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Product out of stock", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Hi,", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
        echo "</div>
                                        </td>
                                      </tr>
                                      <!-- TITLE ENDING -->
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("{product} is almost out of stock.", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("There are now less than [1]{last_qty}[/1] items in stock.", ["[1]" => "<span class=\"label\">", "[/1]" => "</span>"], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                      <tr>
        ...
        // line 126
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\"><span class=\"warning\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Remaining stock:", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</span> {qty}</div>
                                        </td>
                                      </tr>
                                      <tr>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Replenish your inventory, go to the [1]Catalog > Stocks[/1] section of your back office to manage your stock.", ["[1]" => "<span class=\"label\">", "[/1]" => "</span>"], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
...
";
    ...
    {
        return "@MailThemes\\modern\\modules\\ps_emailalerts\\productoutofstock.html.twig";
    }
    ...
    {
        return array (  286 => 154,  282 => 153,  255 => 131,  251 => 130,  242 => 126,  238 => 125,  229 => 121,  225 => 120,  212 => 112,  207 => 110,  178 => 86,  174 => 85,  161 => 77,  156 => 75,  123 => 47,  116 => 45,  89 => 23,  85 => 22,  71 => 13,  66 => 11,  59 => 6,  55 => 5,  48 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@MailThemes\\modern\\modules\\ps_emailalerts\\productoutofstock.html.twig", "C:\\wamp64\\www\\presta-tests\\mails\\themes\\modern\\modules\\ps_emailalerts\\productoutofstock.html.twig");
    }
}
