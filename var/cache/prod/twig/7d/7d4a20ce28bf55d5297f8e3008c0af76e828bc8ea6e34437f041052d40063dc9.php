...
/* @MailThemes\modern\modules\ps_emailsubscription\newsletter_voucher.html.twig */
class __TwigTemplate_9df97825beb8c8ec0f043cd1f1e0403e00b7ca8265d479491d2d8e6baf5e2a20 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("@MailThemes/modern/components/layout.html.twig", "@MailThemes\\modern\\modules\\ps_emailsubscription\\newsletter_voucher.html.twig", 1);
    ...
    {
        $macros = $this->macros;
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Newsletter Voucher", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Subscribing to newsletter", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Thank you for subscribing to our newsletter. We are pleased to offer you the following voucher:", [], "Emails.Body", ($context["locale"] ?? null));
        echo " <span class=\"label\">{discount}</span></div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
";
    ...
    {
        return "@MailThemes\\modern\\modules\\ps_emailsubscription\\newsletter_voucher.html.twig";
    }
    ...
    {
        return array (  262 => 146,  258 => 145,  231 => 123,  227 => 122,  214 => 114,  209 => 112,  180 => 88,  176 => 87,  163 => 79,  158 => 77,  125 => 49,  118 => 47,  89 => 23,  85 => 22,  71 => 13,  66 => 11,  59 => 6,  55 => 5,  48 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@MailThemes\\modern\\modules\\ps_emailsubscription\\newsletter_voucher.html.twig", "C:\\wamp64\\www\\presta-tests\\mails\\themes\\modern\\modules\\ps_emailsubscription\\newsletter_voucher.html.twig");
    }
}
