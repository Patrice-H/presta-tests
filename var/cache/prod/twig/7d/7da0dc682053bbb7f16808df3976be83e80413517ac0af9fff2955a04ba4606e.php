...
/* @MailThemes\modern\core\password_query.html.twig */
class __TwigTemplate_19a0f2cac79c36f03c5d6bb4133cd2dd55b99a8df2b14e6cd1439fdf96dc9c6f extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("@MailThemes/modern/components/layout.html.twig", "@MailThemes\\modern\\core\\password_query.html.twig", 1);
    ...
    {
        $macros = $this->macros;
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Password Query", [], "Emails.Body", ($context["locale"] ?? null)), "html", null, true);
    }
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Confirmation of password request on {shop_name}", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("You have requested to reset your [1]{shop_name}[/1] login details.", ["[1]" => "<span class=\"label\">", "[/1]" => "</span>"], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                      <tr>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Please note that this will change your current password.", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                        </td>
                                      </tr>
                                      <tr>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("In order to confirm this action, click on the following link:", [], "Emails.Body", ($context["locale"] ?? null));
        echo " <a href=\"{url}\" target=\"_blank\" style=\"color:#25B9D7; font-weight:600;\">{url}</a></div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
        ...
        echo twig_escape_filter($this->env, ($context["align_left"] ?? null), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("If you did not make this request, just ignore this email.", [], "Emails.Body", ($context["locale"] ?? null));
        echo "</div>
                                </td>
                              </tr>
                            </tbody>
...
";
    ...
    {
        return "@MailThemes\\modern\\core\\password_query.html.twig";
    }
    ...
    {
        return array (  331 => 183,  327 => 182,  304 => 164,  300 => 163,  291 => 159,  286 => 157,  257 => 133,  253 => 132,  244 => 128,  240 => 127,  231 => 123,  227 => 122,  214 => 114,  209 => 112,  180 => 88,  176 => 87,  163 => 79,  158 => 77,  125 => 49,  118 => 47,  89 => 23,  85 => 22,  71 => 13,  66 => 11,  59 => 6,  55 => 5,  48 => 3,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "@MailThemes\\modern\\core\\password_query.html.twig", "C:\\wamp64\\www\\presta-tests\\mails\\themes\\modern\\core\\password_query.html.twig");
    }
}
