...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = [
            ...
            'PrestaShop\\OAuth2\\Client\\Provider\\PrestaShop' => 'getPrestaShopService',
    ...
    {
        return $this->services['PrestaShop\\Module\\PrestashopFacebook\\Handler\\EventBusProductHandler'] = new \PrestaShop\Module\PrestashopFacebook\Handler\EventBusProductHandler(($this->services['PrestaShop\\Module\\PrestashopFacebook\\Repository\\ProductRepository'] ?? $this->getProductRepositoryService()));
    }
    ...
    {
        return $this->services['PrestaShop\\Module\\PrestashopFacebook\\Repository\\ProductRepository'] = new \PrestaShop\Module\PrestashopFacebook\Repository\ProductRepository(($this->services['ps_facebook.language'] ?? $this->getPsFacebook_LanguageService()));
    }
    ...
    {
        return $this->services['PrestaShop\\Module\\PsxMarketingWithGoogle\\Repository\\CurrencyRepository'] = new \PrestaShop\Module\PsxMarketingWithGoogle\Repository\CurrencyRepository(($this->services['psxmarketingwithgoogle.currency'] ?? $this->getPsxmarketingwithgoogle_CurrencyService()));
    }
    ...
    /**
     * Gets the public 'PrestaShop\OAuth2\Client\Provider\PrestaShop' shared service.
     *
     * @return \PrestaShop\Module\PsAccounts\Provider\OAuth2\Oauth2ClientShopProvider
     */
    protected function getPrestaShopService()
    {
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'E:\\Projets\\presta-tests\\modules\\productcomments\\src\\Entity']);
        $e->addExcludePaths([0 => 'E:\\Projets\\presta-tests\\modules\\productcomments\\src\\Entity/index.php']);
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'E:\\Projets\\presta-tests\\modules\\ps_checkout\\src\\Entity']);
        $f->addExcludePaths([0 => 'E:\\Projets\\presta-tests\\modules\\ps_checkout\\src\\Entity/index.php']);

        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'E:\\Projets\\presta-tests\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        $c->addDriver($e, 'PrestaShop\\Module\\ProductComment\\Entity');
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => 'E:\\Projets\\presta-tests\\modules\\ps_accounts\\src\\Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        ...
        $a->setProxyDir('E:\\Projets\\presta-tests/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    {
        return $this->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('E:\\Projets\\presta-tests', 'E:\\Projets\\presta-tests/modules/');
    }
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'E:\\Projets\\presta-tests/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(($this->services['prestashop.core.localization.cldr.cache.adapter'] ?? ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'E:\\Projets\\presta-tests/var/cache/prod\\/localization'))));
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('8.0.1', 'E:\\Projets\\presta-tests', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('8.0.1', 'E:\\Projets\\presta-tests');
    }
    ...
    {
        return $this->services['ps_checkout.pay_later.configuration'] = new \PrestaShop\Module\PrestashopCheckout\PayPal\PayPalPayLaterConfiguration(($this->services['ps_checkout.configuration'] ?? $this->getPsCheckout_ConfigurationService()), ($this->services['ps_checkout.customer'] ?? $this->getPsCheckout_CustomerService()), ($this->services['ps_checkout.merchant'] ?? ($this->services['ps_checkout.merchant'] = new \PrestaShop\Module\PrestashopCheckout\Merchant())));
    }
    ...
    {
        return $this->services['ps_checkout.paypal.provider.merchant_integration'] = new \PrestaShop\Module\PrestashopCheckout\PayPal\PayPalMerchantIntegrationProvider(($this->services['ps_checkout.cache.paypal.merchant_integration'] ?? $this->getPsCheckout_Cache_Paypal_MerchantIntegrationService()));
    }
    ...
    {
        return $this->services['ps_checkout.persistent.configuration'] = new \PrestaShop\Module\PrestashopCheckout\PersistentConfiguration(($this->services['ps_checkout.configuration'] ?? $this->getPsCheckout_ConfigurationService()));
    }
    ...
    {
        return $this->services['ps_checkout.repository.paypal.account'] = new \PrestaShop\Module\PrestashopCheckout\Repository\PaypalAccountRepository(($this->services['ps_checkout.configuration'] ?? $this->getPsCheckout_ConfigurationService()));
    }
    ...
    {
        return $this->services['ps_checkout.store.module.firebase'] = new \PrestaShop\Module\PrestashopCheckout\Presenter\Store\Modules\FirebaseModule(($this->services['ps_checkout.repository.prestashop.account'] ?? $this->getPsCheckout_Repository_Prestashop_AccountService()));
    }
    ...
    {
        return $this->services['ps_checkout.store.module.paypal'] = new \PrestaShop\Module\PrestashopCheckout\Presenter\Store\Modules\PaypalModule(($this->services['ps_checkout.repository.paypal.account'] ?? $this->getPsCheckout_Repository_Paypal_AccountService()));
    }
    ...
    {
        return $this->services['ps_checkout.updater.paypal.account'] = new \PrestaShop\Module\PrestashopCheckout\Updater\PaypalAccountUpdater(($this->services['ps_checkout.persistent.configuration'] ?? $this->getPsCheckout_Persistent_ConfigurationService()), ($this->services['ps_checkout.paypal.provider.merchant_integration'] ?? $this->getPsCheckout_Paypal_Provider_MerchantIntegrationService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.root_dir' => 'E:\\Projets\\presta-tests/app',
            'kernel.project_dir' => 'E:\\Projets\\presta-tests',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'E:\\Projets\\presta-tests/var/cache/prod\\',
            ...
            'ps_cache_dir' => 'E:\\Projets\\presta-tests/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'E:\\Projets\\presta-tests/var/cache/prod\\/doctrine/orm/Proxies',
