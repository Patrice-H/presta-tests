...
class appAppKernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'mbo.addons.event_listener.addons_credentials_encryption_listener' => 'getMbo_Addons_EventListener_AddonsCredentialsEncryptionListenerService',
            'mbo.addons.user.credentials_encryptor' => 'getMbo_Addons_User_CredentialsEncryptorService',
            'mbo.security.admin_authentication.provider' => 'getMbo_Security_AdminAuthentication_ProviderService',
            ...
            'prestashop.core.crypto.hashing' => 'getPrestashop_Core_Crypto_HashingService',
        ...
        $this->fileMap = [
            ...
            'PrestaShop\\Module\\Mbo\\Api\\Handler\\ErrorHandler\\ErrorHandler' => 'getErrorHandlerService.php',
            ...
            'PrestaShop\\OAuth2\\Client\\Provider\\PrestaShop' => 'getPrestaShopService.php',
            ...
            'mbo.modules.state_machine' => 'getMbo_Modules_StateMachineService.php',
            'mbo.modules.state_machine.eventsubscriber.transition' => 'getMbo_Modules_StateMachine_Eventsubscriber_TransitionService.php',
            'mbo.modules.state_machine.module_status_transition_handler' => 'getMbo_Modules_StateMachine_ModuleStatusTransitionHandlerService.php',
            'mbo.modules.state_machine.source_retriever.url' => 'getMbo_Modules_StateMachine_SourceRetriever_UrlService.php',
            'mbo.modules.state_machine.transitions_manager' => 'getMbo_Modules_StateMachine_TransitionsManagerService.php',
        ...
        $this->aliases = [
            'PrestaShop\\Module\\Mbo\\Api\\Handler\\ErrorHandler\\ErrorHandlerInterface' => 'PrestaShop\\Module\\Mbo\\Api\\Handler\\ErrorHandler\\ErrorHandler',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('SC8QvO7iqP', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'acm-prestashop', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_checkout'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
        $f->addExcludePaths([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_checkout'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity/index.php')]);
        ...
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_accounts'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]), 'PrestaShop\\Module\\PsAccounts\\Entity');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.response', [0 => function () {
            return ($this->services['mbo.addons.event_listener.addons_credentials_encryption_listener'] ?? $this->getMbo_Addons_EventListener_AddonsCredentialsEncryptionListenerService());
        }, 1 => 'onKernelResponse'], 0);
        $instance->addListener('kernel.response', [0 => function () {
        ...
        $instance->addListener('workflow.transition', [0 => function () {
            return ($this->services['mbo.modules.state_machine.eventsubscriber.transition'] ?? $this->load('getMbo_Modules_StateMachine_Eventsubscriber_TransitionService.php'));
        }, 1 => 'onWorkflowTransition'], 0);
        $instance->addListener('module.install', [0 => function () {
    ...
    /*
     * Gets the public 'mbo.addons.event_listener.addons_credentials_encryption_listener' shared service.
     *
     * @return \PrestaShop\Module\Mbo\Addons\Listener\AddonsCredentialsEncryptionListener
     */
    protected function getMbo_Addons_EventListener_AddonsCredentialsEncryptionListenerService()
    {
        return $this->services['mbo.addons.event_listener.addons_credentials_encryption_listener'] = new \PrestaShop\Module\Mbo\Addons\Listener\AddonsCredentialsEncryptionListener(($this->services['session'] ?? $this->getSessionService()), ($this->services['mbo.addons.user.credentials_encryptor'] ?? $this->getMbo_Addons_User_CredentialsEncryptorService()));
    }
    ...
    {
        return $this->services['mbo.addons.user.credentials_encryptor'] = new \PrestaShop\Module\Mbo\Addons\User\CredentialsEncryptor(($this->services['mbo.security.admin_authentication.provider'] ?? $this->getMbo_Security_AdminAuthentication_ProviderService()));
    }

    /*
     * Gets the public 'mbo.security.admin_authentication.provider' shared service.
     *
     * @return \PrestaShop\Module\Mbo\Api\Security\AdminAuthenticationProvider
     */
    protected function getMbo_Security_AdminAuthentication_ProviderService()
    {
    ...
    /*
     * Gets the public 'prestashop.core.crypto.hashing' shared service.
     *
     * @return \PrestaShop\PrestaShop\Core\Crypto\Hashing
     */
    protected function getPrestashop_Core_Crypto_HashingService()
    {
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2YLH7yycvc', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('grBMFqDDvGXFeBySU9JD7CmCN3JjodfI4jjaWRAha0bM8etErbmTAqswdmXtoErZ'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'modules_translation_paths' => [
                ...
                27 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/mbeshipping/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/ps_accounts/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/ps_brandlist/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/ps_checkout/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/ps_checkpayment/translations'),
                38 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/ps_facebook/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/ps_mbo/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/ps_metrics/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/ps_supplierlist/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/ps_viewedproduct/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                48 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                ...
                51 => (\dirname(__DIR__, 4).'/modules/statsbestproducts/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                58 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                59 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/statssearch/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
            ],
            ...
            'kernel.secret' => 'grBMFqDDvGXFeBySU9JD7CmCN3JjodfI4jjaWRAha0bM8etErbmTAqswdmXtoErZ',
