...
class Ybc_newsletter extends Module
{
    ...
    public function __construct()
	{
        ...
        $this->templates = array(
            ...
            'ynpt7' => array(
                'YBC_NEWSLETTER_POPUP_CONTENT' => isset($data->YBC_NEWSLETTER_POPUP_CONTENT) ?  (string)$data->YBC_NEWSLETTER_POPUP_CONTENT : '',
                'YBC_NEWSLETTER_POPUP_BUTTON_COLOR' => '#fbb700',
                'YBC_NEWSLETTER_POPUP_TITLE' => $this->l('Welcome to kids shop!'),
                'YBC_NEWSLETTER_POPUP_SUBTITLE' => '',
                'YBC_NEWSLETTER_POPUP_BUTTON_HOVER_COLOR' => '#fbb700',     
                'YBC_NEWSLETTER_IMAGE' => 'ynpt7.jpg',   
                'YBC_NEWSLETTER_LOGO' => 'logo7.png'      
            ),
            'ynpt6' => array(
                'YBC_NEWSLETTER_POPUP_CONTENT' => isset($data->YBC_NEWSLETTER_POPUP_CONTENT) ?  (string)$data->YBC_NEWSLETTER_POPUP_CONTENT : '',
                'YBC_NEWSLETTER_POPUP_BUTTON_COLOR' => '#27bb9b',
                'YBC_NEWSLETTER_POPUP_TITLE' => $this->l('Welcome to our online store'),
                'YBC_NEWSLETTER_POPUP_SUBTITLE' => '',
                'YBC_NEWSLETTER_POPUP_BUTTON_HOVER_COLOR' => '#27bb9b',     
                'YBC_NEWSLETTER_IMAGE' => 'ynpt8.jpg',   
                'YBC_NEWSLETTER_LOGO' => 'logo8.png'      
            ),
            'ynpt9' => array(
                'YBC_NEWSLETTER_POPUP_CONTENT' => isset($data->YBC_NEWSLETTER_POPUP_CONTENT) ?  (string)$data->YBC_NEWSLETTER_POPUP_CONTENT : '',
                'YBC_NEWSLETTER_POPUP_BUTTON_COLOR' => '#ffffff',
                'YBC_NEWSLETTER_POPUP_TITLE' => $this->l('Welcome to jewelry store!'),
                'YBC_NEWSLETTER_POPUP_SUBTITLE' => '',
                'YBC_NEWSLETTER_POPUP_BUTTON_HOVER_COLOR' => '#fe8b90',     
                'YBC_NEWSLETTER_IMAGE' => 'ynpt9.jpg',   
                'YBC_NEWSLETTER_LOGO' => 'logo9.png'      
            ),                    
        );
        //Config fields        
        $this->configs = array(
